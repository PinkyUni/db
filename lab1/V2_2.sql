...
ORDER BY Name DESC OFFSET 2 ROWS FETCH NEXT 5 ROWS ONLY;
GO


/*
	Вывести на экран список неповторяющихся позиций, которые соответствуют первому уровню позиций в организации (OrganizationLevel).
*/
